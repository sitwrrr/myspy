   ...
   // 设置嘴部动画
    setMouthOpenY(v) {
        ...
        try {
            ...
            // 尝试不同的参数名/大小写组合，成功后立即返回
            try { coreModel.setParameterValueById('PARAM_MOUTH_OPEN_Y', v); return; } catch (e) {}
            try { coreModel.setParameterValueById('ParamMouthOpenY', v); return; } catch (e) {}
            try { coreModel.SetParameterValue('PARAM_MOUTH_OPEN_Y', v); return; } catch (e) {}
            try { coreModel.SetParameterValue('ParamMouthOpenY', v); return; } catch (e) {}
    ...
    setupInitialModelProperties() {
        ...
        if (rememberPosition && savedPos?.x != null && savedPos?.y != null &&
            ...
            this.model.viewRect = this._savedToViewRect(1.0, 0.6, 0.5);
    ...
    _clampViewRect() {
        ...
        const margin = 80 * (window.devicePixelRatio || 1);
